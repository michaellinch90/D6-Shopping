...
(async function(){
    ...
    const items = await Item.create ([
        ...
        //categories[5] = Dairy
        {name: 'Butter', picture: '', category: categories[5], price: 1.00},
        {name: 'Shredded Cheese', picture: '', category: categories[5], price: 1.00},
        {name: 'Sliced Cheese', picture: '', category: categories[5], price: 1.00},
        {name: 'Eggs', picture: '', category: categories[5], price: 1.00},
        {name: 'Milk', picture: '', category: categories[5], price: 1.00},
        {name: 'Sour Cream', picture: '', category: categories[5], price: 1.00},
        //categories[6] = Essentials
        {name: 'Dish Soap', picture: '', category: categories[6], price: 1.00},
        {name: 'Sponges', picture: '', category: categories[6], price: 1.00},
        {name: 'Paper Plates', picture: '', category: categories[6], price: 1.00},
        {name: 'Plastic Utensils', picture: '', category: categories[6], price: 1.00},
        {name: 'Napkins', picture: '', category: categories[6], price: 1.00},
        {name: 'Tissues', picture: '', category: categories[6], price: 1.00},
    ]);
